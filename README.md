...
spacy.NER.v3 supports both zero-shot and few-shot prompting. This version allows explicitly defining the provided
labels with custom descriptions and commas in entity names.
