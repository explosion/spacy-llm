# class PromptableLangChain:
#     def __init__(
#         self,
#         backend: str,
#         prompt: Callable[[LLM, Iterable[Any]], Iterable[Any]],
#         **kwargs
#     ):
#         """Initialize wrapper for MiniChain.
#         backend (str): Name of any backend class in langchain.backend, e. g. OpenAI.
#         prompt (Callable[[LLM, Iterable[Any]], Iterable[Any]]): Callable executing prompts.
#         """
