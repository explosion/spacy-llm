...
from .util import ELExample, ent_desc_reader_csv, score
...
def make_candidate_selector_pipeline(
    ...
    el_component_name: str = "entity_linker",
    top_n: int = 5,
    ...
    desc_path (Optional[Union[Path, str]]): Path to .csv file with descriptions for entities. Has to have two columns
    ...
    return PipelineCandidateSelector(
        nlp_path=nlp_path,
        el_component_name=el_component_name,
        top_n=top_n,
        desc_path=desc_path,
