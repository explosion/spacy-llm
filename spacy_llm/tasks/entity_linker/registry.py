...
from ...ty import CandidateSelector, ExamplesConfigType, FewshotExample
...
def make_candidat_selector_pipeline(
    ...
    """Instantiates Callable generated by loading and wrapping a spaCy pipeline with an NEL component and a filled
    knowledge base.
