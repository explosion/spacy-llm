                    ...
                    if "blocked" in error_message:
                        ...
                        if self._strict:
                            raise ValueError(
                                ...
                                "If you wish to ignore and continue, you can pass 'False' to the 'strict' argument of "
                                "this model. However, note that this will affect how spacy-llm parses the response."
                            ) from ex
                    else:
